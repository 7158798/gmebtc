...
<div id="siteNoty" class="notification-box"><div class="noty_message">【重要通知】： <a id="siteNotyCon" href="/article/16451" >gate.io充值量子链(QTUM)赢取QTUM大奖活动公告</a><a class="close pull-right" href=javascript:;></a></div></div><div class="header clearfix">
    <div class="top-up">
        <div class="top-con">
            <ul class="topprice">
				<li> BTC/CNY : ￥ <span class="topnum">54862.99</span><i class="icon-arrow-up">&uarr;</i> </li>
                <li> ETH/CNY : ￥ <span class="topnum">4614.07</span><i class="icon-arrow-up">&uarr;</i> </li>
                <li> LTC/CNY : ￥ <span class="topnum">889.26</span><i class="icon-arrow-up">&uarr;</i> </li>
                <li> QTUM/CNY : ￥ <span class="topnum">106.68</span><i class="icon-arrow-up">&uarr;</i> </li>
            </ul>
            <div class="qqtel">
                                ...
                                <div class="tier-info" id="tierMenu">
                                    <ul>
                                        ...
                                        <li>升级还需要 <strong>3.0</strong> BTC 或者
                                            <strong>164730</strong> CNY 30天交易量
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<style>
    .excel {background:#3f67af;height:38px; width:38px;float:right; margin-left:12px;cursor:pointer; text-align: center}
    ...
    .date-search-input{ width:242px }
    #action_type{ width: 100px; height: 38px; padding: 0 10px; line-height: 38px;}
	#status_type{ width: 90px; height: 38px; padding: 0 10px; line-height: 38px;}
    #query{ width: 60px; text-align: center; margin-left: 12px}
</style>

<form method="post" id="form">
    <div style="float:left;padding-right: 12px;" id="">
        <span>类型:</span>
        <select name="action_type" id="action_type" class="inputRate">
	...
	<div style="float:left;padding-right: 12px;" id="">
        <span>状态:</span>
        <select name="status_type" id="status_type" class="inputRate">
            <option value="">全部</option>
    ...
    <div class="choiceTime pull-left">
        <span>时间:</span>
        <input id="beginDate" class="date-search-input inputLeft datetimepicker inputRate" type="text"  autocomplete="off" tabindex="1"  value="2018-05-01" name="startTime">
        <span class="ui-separator-pd ">-</span>
        <input id="endDate" class="date-search-input datetimepicker inputRate" type="text" autocomplete="off" tabindex="2"  value="2018-05-21" name="endTime">
    </div>
    <a id="query" class="sub-btn pull-left">查询</a>
</form>
<span class="excel exportExcel" title="下载"><svg viewBox="0 0 24 24" class="icon"><path d="M19 9h-4V3H9v6H5l7 7 7-7zM5 18v2h14v-2H5z"></path></svg></span>
<div class="sectioncont mytradehistory-con">
    <table class='sf-grid table-inacc table-inacc-head'>
        <thead>
            <tr>
                <th align='left'><b>交易单号</b></th>
                <th align='center'><b>日期</b></th>
                <th align='center'><b>交易类型</b></th>
                <th align='center'><b>资金类型</b></th>
                <th align='center'><b>支付方式</b></th>
                <th align='center'><b>成交价</b></th>
                <th align='center'><b>成交量</b></th>
                <th align='center'><b>总计</b></th>
                <th align='center'><b>订单状态</b></th>
				<th align='center'><b>对方姓名</b></th>
				<th align='center'><b>申诉历史</b></th>
            </tr>
        </thead>
    </table>
...
<br><br>
<div id="servTime">当前服务器时间: <b>2018-05-21 17:36:41 UTC+8</b></div>
<div>每个用户单日最多下载三十次</div>
...
<script>
    ...
    function exportExcel() {
        ...
        input2.type = "text";
        input2.name = 'action_type';
        input2.value = action_type;
        form1.appendChild(input2);
		
		var input3 = document.createElement("input");
        input3.type = "text";
        input3.name = 'status_type';
        input3.value = status_type;
        form1.appendChild(input3);
		
        form1.method = "POST";
        form1.action = "/myaccount/exportc2cmyhistory/";
        form1.submit();
...
<div class="footer">
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <div class="vol-all">
                <span>成交量:</span>
				<span> USDT : $<span id="usdtAll">130508405</span> </span>
                <span> BTC : ฿<span id="btcAll">651</span> </span>
                <span> LTC : Ł<span id="ltcAll">2765</span> </span>
                <span> ETH : E<span id="ethAll">31446</span> </span>
            </div>
            <span id="runTime">
                <!--<a href="#">gate.io</a> is powered by <a href="#">gate.io Dev Team</a>-->
                <span class="admin-view"> Elapsed:19.909ms - cnst:12.5;14:0.3;12:0.4;13:1.2; .234 &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
...
<script>
    ...
    $("#usdtAll").text(toThousands(130508405));
    $("#btcAll").text(toThousands(651));
    $("#ltcAll").text(toThousands(2765));
    $("#ethAll").text(toThousands(31446));
