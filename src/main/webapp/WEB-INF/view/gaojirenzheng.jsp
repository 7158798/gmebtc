...
<script type="text/javascript">
	...
	<div class="main_content acc-m-con">
			...
			<style>
    .formbox {min-height:20px;margin:0 auto;border:1px;min-width:60px;}
    .formbox table {width:70%;margin:0 auto;}
    .formbox table th {line-height:26px;padding:10px;vertical-align:top;text-align:center;border:none;font-weight:normal;font-size:16px;color:#333;}
    .formbox table td {border:none}
    .formbox table th b {color:#ff5e23;margin:0 3px;}
    .formbox .sfz {position:relative;border:1px solid #f0f0f0;text-align:center;padding:20px;min-width:60px;min-height:155px;max-height:300px;}
    @media screen and (min-width:1800px) {.formbox .sfz {min-height:260px;}}
    .formbox .sfz:before {content:'>';position:absolute;top:50%;right:-30%;font-size:48px;color:#ccc;font-weight:100;}
    .formbox .sfz.pho-active:before {color:#44d5bc;}
    .upfile-form-con form:last-child .sfz:before {display:none;}
    .formbox .sfz-img {overflow:hidden;}
    .formbox .sfz-img img {height:auto;width:100%}
    ...
    .formbox .file {position:absolute;top:0;left:0;z-index:3;height:100%;width:100%;overflow:hidden;line-height:120px;filter:alpha(Opacity=1);-moz-opacity:0.01;opacity:0.01;cursor:pointer;padding:0;margin:0!important;}
    .id-info-table tr td:first-child {width:150px}
    .sfz {position:relative}
    .sfz i {position:absolute;right:0;bottom:0;width:20px;height:20px;line-height:20px;background:#44d5bc;font-style:normal;text-align:center;color:#fff;#display:none;}
    .red {color:#ff5e23}
    .sfz b {position:absolute;left:0;top:0;width:100%;height:100%;}
    .sfz-cover {width:100%;height:100%;position:absolute;top:0;left:0;background:rgba(0,0,0,0.6);z-index:-1;opacity:0}
    .sfz:hover .sfz-cover {opacity:1;z-index:2}
    .sectioncont .upfile-btn {margin:50% auto;}
    .sectioncont .btn-primary {background:#0c9c83;}
    .sectioncont .btn-warning {background:#ff5e23;}
    .re-btn {padding:10px 20px;border:1px solid #ddd;margin-left:15px}
    .upfile-form-con form {width:25%;float:left; margin: 0}
    .step-title {text-align:center;margin-top:10px;font-size:16px;color:#888;}
</style>
    ...
    <div class="formbox sectioncont">
        ...
        <table>
            <tr>
                ...
                <th>手势示例：</th>
                <td>
                    <img src="images/kyc/id-gesture-all.jpg"/>
                </td>


            </tr>
        </table>
        <div style="margin:20px 0 10px;font-size: 16px"><label>上传手势照片(账号后四位)：</label><span><span class=red><b id="myID">1581772</b></span></span></div>
        <div class="upfile-form-con clearfix">
            <form accept-charset="UTF-8" action="https://up.qbox.me" class="kyc form" enctype="multipart/form-data"
                  method="post">

                <table>
                    <tr><th>手势<b class="step1-num"></b>照片：</th></tr>
                    <tr>

                        <td>
                            <div class="sfz i-z">
                                                                    <input id="key" name="key" value="kyc/idcard/id-gesture-first-4a8ffbaa8a-94057d081e-a73072-753346" type="hidden">
                                    <input id="token" name="token" value="6q4TQXxXzdbLIlKBaKdLUzwlgtnvAvHUxOH67T6K:QQi3H8RUsb2gd9UhLXb8q8ju93c=:" type="hidden">
                                    ...
                                    <img src="images/kyc/id-gesture-1.jpg"/>
                                </div>
                                                                    <div class="sfz-cover">
            ...
            <form accept-charset="UTF-8" action="https://up.qbox.me" class="kyc form" enctype="multipart/form-data"
                  method="post">
                <table>
                    <tr><th>手势<b class="step2-num"></b>照片：</th></tr>
                    <tr>
                        <td>
                            <div class="sfz i-z">
                                                                    <input id="key" name="key" value="kyc/idcard/id-gesture-second-24b84a3dcc-9ed9ba7716-21327d-d4f412" type="hidden">
                                    <input id="token" name="token" value="6q4TQXxXzdbLIlKBaKdLUzwlgtnvAvHUxOH67T6K:QQi3H8RUsb2gd9UhLXb8q8ju93c=:" type="hidden">
                                ...
                                <div class="sfz-img img2">
                                    <img src="images/kyc/id-gesture-7.jpg"/>
                                </div>
                                                                    <div class="sfz-cover">
                                        <div class="upfile-btn sub-btn btn-primary">上传文件</div>
                                    </div>
            ...
            <form accept-charset="UTF-8" action="https://up.qbox.me" class="kyc form" enctype="multipart/form-data"
                  method="post">
                <table>
                    <tr><th>手势<b class="step3-num"></b>照片：</th></tr>
                    <tr>

                        <td>
                            <div class="sfz i-z">
                                                                    <input id="key" name="key" value="kyc/idcard/id-gesture-third-b7a19d0d77-e7f90033f6-fc59b8-c2c5e0" type="hidden">
                                    <input id="token" name="token" value="6q4TQXxXzdbLIlKBaKdLUzwlgtnvAvHUxOH67T6K:QQi3H8RUsb2gd9UhLXb8q8ju93c=:" type="hidden">
            ...
            <form accept-charset="UTF-8" action="https://up.qbox.me" class="kyc form" enctype="multipart/form-data"
                  method="post">
                <table>
                    <tr><th>手势<b class="step4-num"></b>照片：</th></tr>
                    <tr>
                        <td>
                            <div class="sfz i-z">
                                                                    <input id="key" name="key" value="kyc/idcard/id-gesture-four-2b0ab34d8b-da22cc17bd-4c0a74-81660a" type="hidden">
                                    <input id="token" name="token" value="6q4TQXxXzdbLIlKBaKdLUzwlgtnvAvHUxOH67T6K:QQi3H8RUsb2gd9UhLXb8q8ju93c=:" type="hidden">
                                    <input name="x:category" value="id-gesture-four" type="hidden">

                                    <input class="file" name="file" id="file" type="file"/>
                                                                    <div class="sfz-img img4">
                                    <img src="images/kyc/id-gesture-2.jpg"/>
                                </div>
                                                                    <div class="sfz-cover">
                                        <div class="upfile-btn sub-btn btn-primary">上传文件</div>
                                    </div>
        ...
        <div class="sectioncont">
            <form enctype="application/x-www-form-urlencoded" method="post" action="" id="reset-form">
                <div class="sectioncont">
                    ...
                    <p> 3. 请确保照片无水印，无污渍，手势清晰，上半身完整！<a class="re-btn" href="javascript:void(0);"
                                                              onclick="OnResetUpload();">重新上传</a></p>
                </div>
            </form>
        </div>
    </div>
    <div class="sectioncont">
        ...
        <form enctype="application/x-www-form-urlencoded" method="post" action="">
            <table class="id-info-table">
                ...
                <tr>
                    <td>
                        <input type="submit" name="submit" id="submit" value="  已确认无误，提交 " class="sub-btn">
                    </td>
                </tr>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".file").change(function (e) {
            ...
            filename=src.value;
            readFile(file,fBox.find(".sfz-img"));
        });
		
        var on =document.querySelector(".sfz-img");
            ...
            reader.addEventListener('load',function () {
                switch (file.type){
                    ...
                    case 'image/gif':
                        ...
                        element.append(img);
                        element.show();
                        element.siblings(".sfz-cover").find(".sub-btn").removeClass("btn-primary").addClass("btn-warning").text("重新选择文件");
                        element.siblings("i").show();
                        element.parents(".sfz").addClass("pho-active");
                        break;
                }
            });
        }
...
<div class="footer">
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <div class="vol-all">
                <span>成交量:</span>
				<span> USDT : $<span id="usdtAll">132888684</span> </span>
                <span> BTC : ฿<span id="btcAll">653</span> </span>
                <span> LTC : Ł<span id="ltcAll">2383</span> </span>
                <span> ETH : E<span id="ethAll">31901</span> </span>
            </div>
            <span id="runTime">
                <!--<a href="#">gate.io</a> is powered by <a href="#">gate.io Dev Team</a>-->
                <span class="admin-view"> Elapsed:15.399ms - cnst:4.9;14:0.3;12:0.5;13:1.2; .234 &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
...
<script>
    ...
    $("#usdtAll").text(toThousands(132888684));
    $("#btcAll").text(toThousands(653));
    $("#ltcAll").text(toThousands(2383));
    $("#ethAll").text(toThousands(31901));
