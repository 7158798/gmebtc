...
<html>
    ...
    <title>gate.ioHelp - Gate.io - The Gate of Blockchain Assets Exchange</title>
...
<div class="header clearfix">
	...
	<body>
	<link rel="stylesheet" href="css/help.css?v=0519">
		<div class="article-help">
			<div class="article-bj">
				<h1>问题中心</h1>
				<h2>gate.io 客户支持 / 常见问题解答<span class="pull-right help-ask-link">找不到想要的答案？您可以<a href="javascript:ticketsRoute();">发起提问</a></span></h2>
			</div>
							
				<div class="container">
					<div class="page-header">
						<ul id="tabs">
							<li class="active">C2C交易</li>
							<li>新手指导</li>
							<li>常见问题</li>
						</ul>
					</div>
					<div class="article">
						<div id="list_1">
							<ul class="article-list">
																	<li class="arti-item">
										<a href="/help/c2c/16439" class="article-list-link">C2C场外交易商家操作说明</a>
									</li>
																	<li class="arti-item">
										<a href="/help/c2c/16438" class="article-list-link">如何联系卖家？</a>
									</li>
																	<li class="arti-item">
										<a href="/help/c2c/16404" class="article-list-link">C2C场外交易商家操作说明</a>
									</li>
																	<li class="arti-item">
										<a href="/help/c2c/16403" class="article-list-link">C2C场外交易操作说明</a>
									</li>
																	<li class="arti-item">
										<a href="/help/c2c/16397" class="article-list-link">C2C场外交易须知</a>
									</li>
															</ul>
						</div>
						<div id="list_2">
	...
	<script src="js/help.js?v=0518"></script>
	<div class="footer">
    <div class="fkicon">
        <ul class="clearfix">
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <div class="vol-all">
                <span>成交量:</span>
				<span> USDT : $<span id="usdtAll">133641805</span> </span>
                <span> BTC : ฿<span id="btcAll">660</span> </span>
                <span> LTC : Ł<span id="ltcAll">2417</span> </span>
                <span> ETH : E<span id="ethAll">31946</span> </span>
            </div>
            <span id="runTime">
                <!--<a href="#">gate.io</a> is powered by <a href="#">gate.io Dev Team</a>-->
                <span class="admin-view"> Elapsed:5.104ms &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
...
<script>
    ...
    $("#usdtAll").text(toThousands(133641805));
    $("#btcAll").text(toThousands(660));
    $("#ltcAll").text(toThousands(2417));
    $("#ethAll").text(toThousands(31946));
