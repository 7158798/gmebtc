...
<div id="siteNoty" class="notification-box"><div class="noty_message">【重要通知】： <a id="siteNotyCon" href="/article/16451" >gate.io充值量子链(QTUM)赢取QTUM大奖活动公告</a><a class="close pull-right" href=javascript:;></a></div></div><div class="header clearfix">
    <div class="top-up">
        <div class="top-con">
            <ul class="topprice">
				<li> BTC/CNY : ￥ <span class="topnum">54909.95</span><i class="icon-arrow-up">&uarr;</i> </li>
                <li> ETH/CNY : ￥ <span class="topnum">4624.97</span><i class="icon-arrow-up">&uarr;</i> </li>
                <li> LTC/CNY : ￥ <span class="topnum">889.26</span><i class="icon-arrow-up">&uarr;</i> </li>
                <li> QTUM/CNY : ￥ <span class="topnum">106.62</span><i class="icon-arrow-up">&uarr;</i> </li>
            </ul>
            <div class="qqtel">
...
<style>
    ...
    #currencyId{ width: 120px; height: 38px; padding: 0 10px; line-height: 38px;}
    #query{ width: 60px; text-align: center; margin-left: 12px}
</style>

<form method="post" id="form" action="/myaccount/myhistory">
	<div style="float:left;padding-right: 12px;" id="basecurrencies">
		<span>市场:</span>
		<select name="base_curr" id="currencyId" class="inputRate">
	...
	<div style="float:left;padding-right: 12px;" id="currencies">
		<span>币种:</span>
		<select name="curr_type" id="currencyId" class="inputRate">
			<option value="">全部</option>
	...
	<div class="choiceTime pull-left">
		<span>时间:</span>
		<input id="beginDate" class="date-search-input inputLeft datetimepicker inputRate" type="text"  autocomplete="off" tabindex="1"  value="2018-05-01" name="start_time">
		<span class="ui-separator-pd">-</span>
		<input id="endDate" class="date-search-input datetimepicker inputRate" type="text" autocomplete="off" tabindex="2"  value="2018-05-21" name="end_time">
	</div>
...
<div class="sectioncont mytradehistory-con">
    <table class='sf-grid table-inacc table-inacc-head'>
        <thead>
            <tr>
                <th><b>日期</b></th>
                <th align='left'><b>交易类型</b></th>
                <th align='right'><b>交易对</b></th>
                <th align='right'><b>成交价</b></th>
                <th align='right'><b>成交量</b></th>
...
<br><br>
<div id="servTime">当前服务器时间: <b>2018-05-21 17:35:50 UTC+8</b></div>
...
<script>
    ...
    function exportExcel() {
        var startTime = $('#beginDate').val(),
            endTime = $('#endDate').val(),
            currentId = $('#currencyId').val();
        window.open("/myaccount/exportmyhistory?startTime="+ encodeURIComponent(startTime) +"&endTime="+encodeURIComponent(endTime)+"&currentId="+encodeURIComponent(currentId) );
    }
...
<div class="footer">
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <div class="vol-all">
                <span>成交量:</span>
				<span> USDT : $<span id="usdtAll">130534925</span> </span>
                <span> BTC : ฿<span id="btcAll">655</span> </span>
                <span> LTC : Ł<span id="ltcAll">2812</span> </span>
                <span> ETH : E<span id="ethAll">31433</span> </span>
            </div>
            <span id="runTime">
                <!--<a href="#">gate.io</a> is powered by <a href="#">gate.io Dev Team</a>-->
                <span class="admin-view"> Elapsed:9.224ms - cnst:0.9;14:0.3;12:0.4;13:1.2; .234 &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
...
<script>
    ...
    $("#usdtAll").text(toThousands(130534925));
    $("#btcAll").text(toThousands(655));
    $("#ltcAll").text(toThousands(2812));
    $("#ethAll").text(toThousands(31433));
