...
<div class="m_title"><h4>最近提现记录</h4></div>
...
<br><br>
<div id="servTime">当前服务器时间: <b>2018-05-21 18:27:01 UTC+8</b></div>
<script>
	...
	function OnViewCode(id) {
		...
		var view_code = "<h3 style='margin-bottom:10px'>查看完整GATECODE</h3>";
					...
					$.ajax({
						...
						success: function (data, textStatus) {
							...
							if (json_res && json_res.result) {
								...
								view_code += "<tr><td>完整GATECODE: </td></tr>";
								...
								noty({
									...
									buttons: [
										{
											addClass: 'btn btn-danger dp-noty-btn',text: '确定',
...
<div class="footer">
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <div class="vol-all">
                <span>成交量:</span>
				<span> USDT : $<span id="usdtAll">132872908</span> </span>
                <span> BTC : ฿<span id="btcAll">652</span> </span>
                <span> LTC : Ł<span id="ltcAll">2381</span> </span>
                <span> ETH : E<span id="ethAll">31911</span> </span>
            </div>
            <span id="runTime">
                <!--<a href="#">gate.io</a> is powered by <a href="#">gate.io Dev Team</a>-->
                <span class="admin-view"> Elapsed:167.774ms - cnst:1.0;14:0.4;12:0.4;13:1.1; .234 &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
