    ...
    <div class="top-up">
        <div class="top-con">
            <ul class="topprice">
                ...
                <li> ETH/CNY : ￥ <span class="topnum">4583.37</span><i class="icon-arrow-down">&darr;</i> </li>
                <li> LTC/CNY : ￥ <span class="topnum">875.33</span><i class="icon-arrow-down">&darr;</i> </li>
                <li> QTUM/CNY : ￥ <span class="topnum">104.85</span><i class="icon-arrow-down">&darr;</i> </li>
            </ul>
            <div class="qqtel">
                                ...
                                <div class="tier-info" id="tierMenu">
                                    <ul>
                                        ...
                                        <li>升级还需要 <strong>3.0</strong> BTC 或者
                                            <strong>163771</strong> CNY 30天交易量
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<script type="text/javascript">
	...
	<!---->
			...
			<style>
	#fpass{width: 60%; border-radius: 3px; padding: 8px 5px; font-size: 14px; font-family:'microsoft yahei'; border:1px solid #ddd;}
	#tips{ display:block}
	.table-inacc small{ margin-left: 5px; padding-left: 5px; border-left: 1px solid #eee}
	.table-scroll{ max-height: 355px}
</style>

<div class="m_title"><h4>登录日志</h4></div>
<div class="sectioncont logs-con" style="margin-bottom: 30px">
	<table class='sf-grid table-inacc table-inacc-head'>
		<thead>
		<tr>
			<th><b>序号</b></th>
			<th align='left'><b>时间</b></th>
			<th align='right'><b>IP</b></th>
			<th align='right'><b>状态</b></th>
			<th align='right'><b>语言</b></th>
		</tr>
		</thead>
	</table>
	<div class="table-scroll">
		<table class='sf-grid table-inacc table-inacc-body' id="loginLog">
			<tbody>
							<tr>
					<td align='right'>1</td>
					<td align='right'>
						2018-05-21 18:34:47						<small>4 分钟之前</small>
					</td>
					<td align='right'><a href="javascript:OnViewIp('login_ip','21761626');">查看</a></td>
					...
					<td align='right'>2</td>
					<td align='right'>
						2018-05-21 18:02:43						<small>36 分钟之前</small>
					</td>
					<td align='right'><a href="javascript:OnViewIp('login_ip','21759464');">查看</a></td>
					<td align='right'>成功</td>
					<td align='right'>cn</td>
				</tr>
							<tr>
					<td align='right'>3</td>
					<td align='right'>
						2018-05-21 16:04:17						<small>2 小时 35 分钟之前</small>
					</td>
					<td align='right'><a href="javascript:OnViewIp('login_ip','21750557');">查看</a></td>
					<td align='right'>成功</td>
					<td align='right'>cn</td>
				</tr>
							<tr>
					<td align='right'>4</td>
					<td align='right'>
						2018-05-17 10:30:55						<small>4 天 8 小时之前</small>
					</td>
					<td align='right'><a href="javascript:OnViewIp('login_ip','21403146');">查看</a></td>
					<td align='right'>成功</td>
					<td align='right'>cn</td>
				</tr>
							<tr class="table-empty">
					<td style="text-align: center"><p style="font-size: 14px"><i>i</i>暂无登录日志</p></td>
				</tr>
			</tbody>
		</table>
	</div>
...
<div class="m_title"><h4>安全设置日志</h4></div>
<div class="sectioncont logs-con">
	<table class='sf-grid table-inacc table-inacc-head'>
		<thead>
		<tr>
			<th><b>序号</b></th>
	...
	<div class="table-scroll">
		<table class='sf-grid table-inacc table-inacc-body' id="setLog">
			<tbody>
							<tr>
					<td align='right'>1</td>
					<td align='right'>
						2018-05-21 16:16:08						<small>2 小时 23 分钟之前</small>
					</td>
					<td align='right'>身份认证</td>
					<td align='right'><a href="javascript:OnViewIp('user_ip', '4422823');">查看</a>
					</td>
				</tr>
							<tr>
					<td align='right'>2</td>
					<td align='right'>
						2018-05-17 10:34:40						<small>4 天 8 小时之前</small>
					</td>
					<td align='right'>开启手机短信验证</td>
					<td align='right'><a href="javascript:OnViewIp('user_ip', '4361208');">查看</a>
					</td>
				</tr>
							<tr>
					<td align='right'>3</td>
					<td align='right'>
						2018-05-17 10:30:33						<small>4 天 8 小时之前</small>
					</td>
					<td align='right'>email_verify</td>
					<td align='right'><a href="javascript:OnViewIp('user_ip', '4361140');">查看</a>
					</td>
				</tr>
							<tr class="table-empty">
					<td style="text-align: center;"><p style="font-size: 14px"><i>i</i>暂无安全设置日志</p></td>
				</tr>
			</tbody>
		</table>
	</div>
...
<br><br>
<div>当前服务器时间: <b>2018-05-21 18:39:20 UTC+8</b></div>

<br>

<script>
	var $login=$("#loginLog"), $set=$("#setLog");
	if($login.height() >355){
		$login.parent().css("padding-right","10px").prev("table").css("padding-right","26px");
	} else if($login.find("tr").size() == 1){
		$login.find(".table-empty").show()
	}
	if($set.height() >355){
		$set.parent().css("padding-right","10px").prev("table").css("padding-right","26px");
	} else if($set.find("tr").size() == 1){
		$set.find(".table-empty").show()
	}
	$("td:contains('成功')").addClass("green");
	$("td:contains('失败')").addClass("red");

	var lb=$(".leftbar"), mc=$(".main_content"),lh=lb.height(),mh=mc.height();
	lb.css("height",mh)

	function OnViewIp(type, id) {

		var view_code = "<h3 style='margin-bottom:10px'>查看IP</h3>";
		view_code += "<div style='border-bottom:1px solid #333'></div>";
		view_code += "<table id='tablePending' width='100%'>";
		view_code += "<tr><td class='noty-td' width='25%'> </td><td  width='70%'></td></tr>";
		view_code += "<tr><td class='noty-td'>资金密码: </td><td width='10%'>" +
				"<input type='password' name='fpass' id='fpass' onpaste='return false;'/>" +
			...
			buttons: [
				{
					...
					var fpass = $('#fpass').val();
					if (fpass == '') {
						$('#tips').html('<span style=color:#ff5d5d>请输入资金密码</span>');
						$('#fpass').focus();
						return;
					}
					var json_req = {
					...
					$.ajax({
						...
						success: function (data, textStatus) {
							...
							if (json_res && json_res.result) {
								var ip = json_res.ip;
								var location = json_res.location;
								var view_code = "";
								view_code += "<table id='tablePending'>";
								view_code += "<tr><td class='noty-td'>登陆IP: </td><td width='70%'>" + ip + "</td></tr>";
								view_code += "<tr><td class='noty-td'>地理位置: </td><td width='70%'>" + location + "</td></tr>";
								view_code += "</table>";
								view_code += "<br/>";
								noty({
									text: view_code,
						...
						error : function(req, textStatus, err){
							noty({text: "网络错误: " + req.status + " " + req.readyState + " " + textStatus + " " + err,
...
<div class="footer">
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <div class="vol-all">
                <span>成交量:</span>
				<span> USDT : $<span id="usdtAll">133490138</span> </span>
                <span> BTC : ฿<span id="btcAll">660</span> </span>
                <span> LTC : Ł<span id="ltcAll">2414</span> </span>
                <span> ETH : E<span id="ethAll">31957</span> </span>
            </div>
            <span id="runTime">
                <!--<a href="#">gate.io</a> is powered by <a href="#">gate.io Dev Team</a>-->
                <span class="admin-view"> Elapsed:8.008ms - cnst:0.9;14:0.3;12:0.5;13:1.3; .234 &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
...
<script>
    ...
    $("#usdtAll").text(toThousands(133490138));
    $("#btcAll").text(toThousands(660));
    $("#ltcAll").text(toThousands(2414));
    $("#ethAll").text(toThousands(31957));
