...
<div id="siteNoty" class="notification-box"><div class="noty_message">【重要通知】： <a id="siteNotyCon" href="/article/16451" >gate.io充值量子链(QTUM)赢取QTUM大奖活动公告</a><a class="close pull-right" href=javascript:;></a></div></div><div class="header clearfix">
    <div class="top-up">
        <div class="top-con">
            <ul class="topprice">
				<li> BTC/CNY : ￥ <span class="topnum">54825.00</span><i class="icon-arrow-up">&uarr;</i> </li>
                <li> ETH/CNY : ￥ <span class="topnum">4631.94</span><i class="icon-arrow-up">&uarr;</i> </li>
                <li> LTC/CNY : ￥ <span class="topnum">890.10</span><i class="icon-arrow-up">&uarr;</i> </li>
                <li> QTUM/CNY : ￥ <span class="topnum">106.49</span><i class="icon-arrow-up">&uarr;</i> </li>
            </ul>
            <div class="qqtel">
                                ...
                                <div class="tier-info" id="tierMenu">
                                    <ul>
                                        ...
                                        <li>升级还需要 <strong>3.0</strong> BTC 或者
                                            <strong>164243</strong> CNY 30天交易量
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<div class="footer">
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <div class="vol-all">
                <span>成交量:</span>
				<span> USDT : $<span id="usdtAll">130194484</span> </span>
                <span> BTC : ฿<span id="btcAll">656</span> </span>
                <span> LTC : Ł<span id="ltcAll">2768</span> </span>
                <span> ETH : E<span id="ethAll">31361</span> </span>
            </div>
            <span id="runTime">
                <!--<a href="#">gate.io</a> is powered by <a href="#">gate.io Dev Team</a>-->
                <span class="admin-view"> Elapsed:1098.227ms - cnst:0.9;14:0.4;12:0.7;13:1.3; .234 &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
