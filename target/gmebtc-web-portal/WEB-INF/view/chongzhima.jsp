...
<script type="text/javascript">
	...
	<div class="main_content acc-m-con">
			...
			<style>
    .myacc-con td{ border: none}
</style>

<div class="m_title"><h4>使用 充值码(GateCode) 充值</h4></div>


<div class="sectioncont">
    <p><b>请输入您的充值码，点击提交：(<a href="https://gateio.io/article/16402">详细使用说明</a>)</b></p>
    <form action="/myaccount/deposit_gatecode" method="post" name="E_FORM" target=_top>
        <table>
            <tr>
                <td align="right" width=200>充值码：</td>
                <td><input name="gatecode" id="gatecode" type="text" value="" size="40"></td>
            </tr>
            <tr>
                <td align="right">图片验证码：</td>
                <td>
                    <input type="text" name="captcha" id="captcha"/>
                    <img id="btrCaptcha" src="/captcha" alt="Captcha" title="看不清？换一张"
                         onclick="document.getElementById('btrCaptcha').src = '/captcha?' + Math.random(); return false"/>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td><input type="submit" name="submit" id="submit" value="  提交充值码  " class="sub-btn" style="margin-top: 10px"></td>
            </tr>
        </table>
        <br>
        <br>

        <p>充值码分为前后两段，中间以“-”隔开，只提交前半段，可查询充值码面额，也可进一步锁定充值码，提交完整的充值码，可完成充值。</p>
        <p><span class=red>充值码仅限于在平台账户间转账使用，平台不提供充值码交易渠道，禁止跟陌生人交易充值码！如已购买，请务必先提交前半段，并锁定充值码以后，再进行付款，防止受骗。充值码切勿泄露给其他人！</span></p>
        <p>您锁定充值码以后可以完成支付，从转让者手中获得完整充值码，并在此提交，完成充值。</p>
        <p>被锁定的充值码，如2小时内未完成充值，将自动解锁，不再继续受到保护。</p>
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <span id="runTime">
                ...
                <span class="admin-view"> Elapsed:10.575ms - cnst:1.0;14:0.3;12:0.5;13:1.2; .234 &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
