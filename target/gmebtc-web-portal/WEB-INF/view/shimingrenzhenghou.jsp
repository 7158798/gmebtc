...
<div id="siteNoty" class="notification-box"><div class="noty_message">【重要通知】： <a id="siteNotyCon" href="/article/16451" >gate.io充值量子链(QTUM)赢取QTUM大奖活动公告</a><a class="close pull-right" href=javascript:;></a></div></div><div class="header clearfix">
    <div class="top-up">
        <div class="top-con">
            <ul class="topprice">
				<li> BTC/CNY : ￥ <span class="topnum">55217.64</span><i class="icon-arrow-up">&uarr;</i> </li>
                <li> ETH/CNY : ￥ <span class="topnum">4659.12</span><i class="icon-arrow-up">&uarr;</i> </li>
                                ...
                                <div class="tier-info" id="tierMenu">
                                    <ul>
                                        ...
                                        <li>升级还需要 <strong>3.0</strong> BTC 或者
                                            <strong>165653</strong> CNY 30天交易量
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
.s-title i:after{content:"";display:inline-block;height:50px;width:1px;background:#fa0;margin-right:10px;position:absolute;left:20px;top:0;transform:rotate(35deg);}
			...
			<div class="sectioncont">
				<p>实名认证审核中，请耐心等待...!</p>			
				<p>
					<br><span>如有问题<a target="_blank" href="/zendesk">请点击这里提交工单</a></span>
...
<div class="footer">
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <div class="vol-all">
                <span>成交量:</span>
				<span> USDT : $<span id="usdtAll">124245872</span> </span>
                <span> BTC : ฿<span id="btcAll">653</span> </span>
                <span> LTC : Ł<span id="ltcAll">2717</span> </span>
                <span> ETH : E<span id="ethAll">30235</span> </span>
            </div>
            <span id="runTime">
                <!--<a href="#">gate.io</a> is powered by <a href="#">gate.io Dev Team</a>-->
                <span class="admin-view"> Elapsed:1321.178ms - cnst:1.0;14:0.3;12:0.4;13:1.2; .234 &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
...
<script>
    ...
    $("#usdtAll").text(toThousands(124245872));
    $("#btcAll").text(toThousands(653));
    $("#ltcAll").text(toThousands(2717));
    $("#ethAll").text(toThousands(30235));
