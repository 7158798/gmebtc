...
<div id="siteNoty" class="notification-box"><div class="noty_message">【重要通知】： <a id="siteNotyCon" href="/article/16451" >gate.io充值量子链(QTUM)赢取QTUM大奖活动公告</a><a class="close pull-right" href=javascript:;></a></div></div><div class="header clearfix">
    <div class="top-up">
        <div class="top-con">
            <ul class="topprice">
				<li> BTC/CNY : ￥ <span class="topnum">54885.66</span><i class="icon-arrow-up">&uarr;</i> </li>
                <li> ETH/CNY : ￥ <span class="topnum">4633.14</span><i class="icon-arrow-up">&uarr;</i> </li>
                <li> LTC/CNY : ￥ <span class="topnum">886.40</span><i class="icon-arrow-down">&darr;</i> </li>
                <li> QTUM/CNY : ￥ <span class="topnum">106.27</span><i class="icon-arrow-down">&darr;</i> </li>
            </ul>
            <div class="qqtel">
                                ...
                                <div class="tier-info" id="tierMenu">
                                    <ul>
                                        ...
                                        <li>升级还需要 <strong>3.0</strong> BTC 或者
                                            <strong>164657</strong> CNY 30天交易量
                                        </li>
                                    </ul>
                                </div>
                            </div>
...
<script type="text/javascript">
	...
	<div class="main_content acc-m-con">
			...
			<div class="m_title"><a href='/trade/'><h4>Tether (USDT) 充值 </h4></a></div>
			<div class="sectioncont">

				请将USDT汇入如下地址（<a target=_blank href='https://omniexplorer.info/lookupadd.aspx?address=1LifgxL8Bg6isboUWsHmW7CteH911YXuuM'>点击这里查看区块链记录</a>）：<br>		
				<input class='coin_add' style='font-size:20px;' readonly value='1LifgxL8Bg6isboUWsHmW7CteH911YXuuM'>
				<br>或扫描二维码：<br>
				<img src="/libs/qr.php?d=1LifgxL8Bg6isboUWsHmW7CteH911YXuuM" alt="QR code" style="width: 200px; height: 200px"/>
				
								<br>或 基于以太网络的 USDT ERC20 地址：<br>
				<input class='coin_add' style='font-size:26px;' readonly value='0x8E1CFf725877d007FdC95D69401e74b8ef9531b1'>
				<img src="/libs/qr.php?d=0x8E1CFf725877d007FdC95D69401e74b8ef9531b1" alt="QR code" style="width: 200px; height: 200px"/>
				<br>或扫描ERC20二维码：<br>
				<br>
												...
												<br>
								请通过 USDT 客户端或在线钱包将您需要充值的USDT数目发送到该地址。发送完成后，系统会自动在此交易获得 2 个确认后将该笔虚拟币充值到您在本站的账户，2 个确认需要大约 0.5 到 1 小时时间，请耐心等待。
				同一个地址可多次充值，不影响到账。最小充值金额0.0001。
			...
			<br>
			<div class="m_title"><h4>交易中心</h4></div>
			<div class="sectioncont">			
				<table class='sf-grid'>								  				  
					<tr>
										<td><a href='/trade/usdt_cny'>USDT/CNY</a></td>	
																														</tr>							
				</table>					
			</div>
			...
			<div class="sectioncont">
				...
				<!--
				<table class='sf-grid'>				
				  <tr> <td align='right'width="100px"><b>时间</b></td>
				       <td align='right'><b>充值地址/转账ID</b></td>
					   <td align='right' width="100px"><b>充值金额</b></td>
					   <td align='right' width="80px"><b>确认个数</b></td>
                  </tr>
...
<div class="footer">
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <div class="vol-all">
                <span>成交量:</span>
				<span> USDT : $<span id="usdtAll">131293194</span> </span>
                <span> BTC : ฿<span id="btcAll">651</span> </span>
                <span> LTC : Ł<span id="ltcAll">2491</span> </span>
                <span> ETH : E<span id="ethAll">31600</span> </span>
            </div>
            <span id="runTime">
                <!--<a href="#">gate.io</a> is powered by <a href="#">gate.io Dev Team</a>-->
                <span class="admin-view"> Elapsed:11.049ms - cnst:3.6;14:0.3;12:0.2;13:1.1; .234 &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
...
<script>
    ...
    $("#usdtAll").text(toThousands(131293194));
    $("#btcAll").text(toThousands(651));
    $("#ltcAll").text(toThousands(2491));
    $("#ethAll").text(toThousands(31600));
