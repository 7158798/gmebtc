...
<div class="footer">
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <div class="vol-all">
                <span>成交量:</span>
				<span> USDT : $<span id="usdtAll">133552683</span> </span>
                <span> BTC : ฿<span id="btcAll">660</span> </span>
                <span> LTC : Ł<span id="ltcAll">2420</span> </span>
                <span> ETH : E<span id="ethAll">31967</span> </span>
            </div>
            <span id="runTime">
                <!--<a href="#">gate.io</a> is powered by <a href="#">gate.io Dev Team</a>-->
                <span class="admin-view"> Elapsed:8.048ms - cnst:1.0;14:0.4;12:0.4;13:1.1; .234 &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
...
<script>
    ...
    $("#usdtAll").text(toThousands(133552683));
    $("#btcAll").text(toThousands(660));
    $("#ltcAll").text(toThousands(2420));
    $("#ethAll").text(toThousands(31967));
