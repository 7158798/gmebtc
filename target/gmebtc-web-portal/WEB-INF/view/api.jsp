...
<script type="text/javascript">
	...
	<div class="main_content acc-m-con">
			...
			<div class="m_title"><h4>API Keys</h4></div>
            ...
            <form enctype="application/x-www-form-urlencoded" method="post" action="">
                <table id='withdrawtable'>
                    ...
                    <tr>
                        ...
                        <td><input type="password" name="fundpass" id="fundpass" size="20" autocomplete="new-password"></td>
                    </tr>

                                            <tr>
                            <td align="right">短信验证码：</td>
                            <td>
                                <input type="text" value="" size="10" name="smscode" id="smscode">
                    ...
                    <tr>
                        <td>&nbsp;</td>
																								...
																								<td><input type="submit" name="submit" id="submit" value="  显示API keys "
												   class="sub-btn"></td>
...
<script>
    $(document).ready(function (e) {
        ...
        //复制
        var clipboard1 = new Clipboard('.js-copy1'),clipboard2 = new Clipboard('.js-copy2'),clipboard3 = new Clipboard('.js-copy3');
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <span id="runTime">
                ...
                <span class="admin-view"> Elapsed:50.023ms - cnst:3.4;14:0.3;12:0.4;13:1.3; .234 &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
