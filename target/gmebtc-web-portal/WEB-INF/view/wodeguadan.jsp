...
<script type="text/javascript">
	...
	<div class="main_content acc-m-con">
			...
			<div class="m_title"><h4>我的最新挂单</h4></div>
<div class="sectioncont myorders-con">
    <table class='sf-grid table-inacc table-inacc-head'>
        <thead>
            <tr>
                ...
                <th align='right'><b>交易价</b></th>
                <th align='right'><b>挂单量(锁定)</b></th>
    ...
    <div class="table-scroll">
        <table id="myOrderTable" class='sf-grid table-inacc table-inacc-body'>
            <tbody>
                            <tr class="table-empty">
                    <td style="text-align: center"><p><i>i</i>暂无挂单</p></td>
                </tr>
            </tbody>
        </table>
    </div>
...
<br><br>
<div id="servTime">当前服务器时间: <b>2018-05-21 17:34:35 UTC+8</b></div>
<script>
$(function() {
    ...
    function cancel_order(symbol, oid, ifALL) {
        var json_req = {
            type: "cancel",
            symbol: symbol,
            oid: oid
        ...
        $.ajax({
            type: "get",
            url: "/json_svr/exchange/?u=1" + "&c=" + Math.floor(Math.random() * 1000000),
            data: json_req,
            xhrFields: {withCredentials: true},
            success: function (data, textStatus) {
                var json_res = data, view_code = '';
                if (json_res && json_res.result) {
                    ...
                    if (ifALL == 1)
                        $("#myOrderTable").find("tr").remove();
                    else
                        $("#od" + oid).animate({opacity:"0"},'10',function () {
                            $(this).remove()
                        });
                    //checkEmpty(0);
                } else {
                    view_code = "<div class='cancel_content'>撤单失败!" + json_res.msg + "</div>";
                    noty({
                        text: view_code,
                        type: "warning",
                        layout: "bottomLeft",
...
<script>
   // _page = trade_operator(1526924075 , "", 1581772, 0.2);
</script>
    ...
    <div class="fnav">
        ...
        <div class="tail">
            ...
            <span id="runTime">
                ...
                <span class="admin-view"> Elapsed:40.843ms - cnst:1.2;14:0.4;12:0.4;13:1.3; .234 &nbsp; a/e/r </span>
            </span>
        </div>
    </div>
</div>
